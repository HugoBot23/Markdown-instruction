...
В данной инструкции я научился работать с Git и Markdown.
* Всеме командами который выше перечислены.
* Выделять текст в markdown
* Делать списки в markdown
* Работать с изображениями в markdown
* Добавлять ссылки в markdown
* Работь с таблицей в markdown
* Делать цитаты в markdown

Спасибо большое преподавателям Ильнар Шафигуллин и Эльвира Аннаева. За проделаную работу.
Также всему составу GeekBrains большое спасибо за предоставления информацию.